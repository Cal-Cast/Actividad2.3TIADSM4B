...
var iconAguascalientes = L.icon({
    iconUrl: 'png-transparent-computer-icons-art-museum-others-miscellaneous-cdr-logo.png', // Reemplaza con la ruta a tu imagen
...
var iconoPlaza = L.icon({
    iconUrl: 'plazatoros.png', // Reemplaza con la ruta a tu imagen
    iconSize: [38, 38], // Tamaño del ícono
    iconAnchor: [22, 94], // Punto de anclaje del ícono
    popupAnchor: [-3, -76] // Punto de anclaje del pop-up
});
var iconCapital = L.icon({
    iconUrl: 'images (1).png', // Reemplaza con la ruta a tu imagen
    iconSize: [38, 38], // Tamaño del ícono
    iconAnchor: [22, 94], // Punto de anclaje del ícono
    popupAnchor: [-3, -76] // Punto de anclaje del pop-up
});
